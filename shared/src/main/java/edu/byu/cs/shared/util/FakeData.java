...
public class FakeData {
     ...
     */
    public edu.byu.cs.shared.util.Pair<List<User>, Boolean> getPageOfUsers(User lastUser, int limit, User omit) {

        edu.byu.cs.shared.util.Pair<List<User>, Boolean> result = new edu.byu.cs.shared.util.Pair<>(new ArrayList<User>(), false);
     ...
     */
    public edu.byu.cs.shared.util.Pair<List<Status>, Boolean> getPageOfStatus(Status lastStatus, int limit) {

        edu.byu.cs.shared.util.Pair<List<Status>, Boolean> result = new edu.byu.cs.shared.util.Pair<>(new ArrayList<Status>(), false);
